...
if __name__ == "__main__":
    ...
    ## Calling a 'classes' with its parameters creates a new object (or instance) of that class.
    # REMEMBER here we are n\ot calling the functions of above class but instead the class itself with the parameters of __init__ function
