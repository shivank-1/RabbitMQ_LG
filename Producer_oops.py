...
if __name__ == "__main__":
    ...
    ## Calling a 'class' with its prameters creates a new object (or instance) of that class.
    # REMEMBER here we ae nt calling the functions of above class but instead the class itself with the parameters of __init__ function
